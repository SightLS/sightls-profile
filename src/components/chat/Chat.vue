...
export default {
  data() {
    return {
      ...
      {
        user: 'Рамиль',
        text: `Это мой ИИ-ассистент, созданный на базе Gemini 2.5 Flash-Lite. Он может ответить на ваши вопросы обо мне.</br></br> <a href="https://github.com/SightLS/Ramils-gemini-chat" target="_blank">Вот ссылка на репозиторий</a>`,
      },
      ],
      history: [],
      isMinimized: false,
